...
- **Tutor Q&A 乱码修复**：回答、引用摘录入库前会尝试还原常见的中文乱码（例如 UTF-8 被当成 GBK 读过一遍的情况）。
- **同类项目调研**：近一个月 GitHub 上 PDF/视频学习、Quiz、Q&A 项目的整理见 `docs/github-learning-platform-research-2026-09.md`。
